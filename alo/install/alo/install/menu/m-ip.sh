...
listuser=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $2}')
superadmin=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $7}')
...
wget https://raw.githubusercontent.com/akanecutee/permission/main/ip &> /dev/null
...
git remote add origin https://github.com/akanecutee/permission.git &> /dev/null
git push -f https://${tokenscript}@github.com/akanecutee/permission.git &> /dev/null
else
echo -e "$COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│${NC}${COLBG1}          ${WH}• PREMIUM SUPER ADMIN •                ${NC}$COLOR1│ $NC"
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}"
...
function add_ip(){
clear
nama2=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $2}')
author=$(cat /etc/profil)
TIMES="10"
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | awk '{print $4}' | grep $daftar)
...
git branch -M main &> /dev/null
git remote add origin https://github.com/akanecutee/permission &> /dev/null
git push -f https://${tokenscript}@github.com/akanecutee/permission &> /dev/null
sleep 1
d1=$(date -d "$exp" +%s)
d2=$(date -d "$hariini" +%s)
...
sleep 0.5
rm /root/rmbl/ip
wget https://raw.githubusercontent.com/akanecutee/license/main/key &> /dev/null
clear
if [ "$superadmin" = "VIP" ]; then
x=1
while [ $x -le $mkey ]
...
git remote add origin https://github.com/akanecutee/license >/dev/null 2>&1
git push -f https://${tokenkey}@github.com/akanecutee/license >/dev/null 2>&1
echo -e "$COLOR1╭════════════════════════════════╮${NC}"
...
REQIP=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $iprenew | awk '{print $4}')
...
name1=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $iprenew | awk '{print $2}') #name
exp=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $iprenew | awk '{print $3}') #exp
ivps1=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $iprenew | awk '{print $4}') #ip
trial=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $iprenew | awk '{print $5}') #ip
MYIP=$(curl -sS ipv4.icanhazip.com)
UU2=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $2}')
U2=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $5}')
...
ip=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $6}')
if [ "$Isadmin" = "ON" ]; then
echo -ne
else
clear
