...
IPVPS=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $4}')
if [[ $MYIP == $IPVPS ]]; then
domain
Casper2
else
...
res1() {
wget --no-check-certificate https://raw.githubusercontent.com/akanecutee/install/main/install/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
...
clear
wget --no-check-certificate https://raw.githubusercontent.com/akanecutee/install/main/tools.sh &> /dev/null
chmod +x tools.sh 
bash tools.sh
clear
start=$(date +%s)
...
res2() {
wget --no-check-certificate https://raw.githubusercontent.com/akanecutee/install/main/install/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
clear
} 

res3() {
wget --no-check-certificate https://raw.githubusercontent.com/akanecutee/install/main/install/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
}

res4() {
wget --no-check-certificate https://raw.githubusercontent.com/akanecutee/install/main/sshws/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
}

res5() {
wget --no-check-certificate https://raw.githubusercontent.com/akanecutee/install/main/install/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
}

res6() {
wget --no-check-certificate https://raw.githubusercontent.com/akanecutee/install/main/sshws/ohp.sh && chmod +x ohp.sh && ./ohp.sh
clear
}

res7() {
wget --no-check-certificate https://raw.githubusercontent.com/akanecutee/install/main/menu/update.sh && chmod +x update.sh && ./update.sh
clear
}

res8() {
wget --no-check-certificate https://raw.githubusercontent.com/akanecutee/slowdns/main/installsl.sh && chmod +x installsl.sh && bash installsl.sh
clear
}

res9() {
wget --no-check-certificate https://raw.githubusercontent.com/akanecutee/install/main/install/udp-custom.sh && chmod +x udp-custom.sh && bash udp-custom.sh
clear
}
...
MYIP=$(curl -sS ipv4.icanhazip.com)
IZIN=$(curl -sS https://raw.githubusercontent.com/akanecutee/permission/main/ip | grep $MYIP | awk '{print $3}' )
d1=$(date -d "$IZIN" +%s)
d2=$(date -d "$today" +%s)
EXP=$(( (d1 - d2) / 86400 ))
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/akanecutee/install/main/versi  )
