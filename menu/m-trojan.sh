...
trojanlink="trojan://${uuid}@${domain}:443?path=%2FYOURPATH%2Ftrojan-ws&security=tls&host=${domain}&type=ws&sni=${domain}#${user}"
trojan1="trojan://${uuid}@${domain}:443?mode=gun%26security=tls%26type=grpc%26serviceName=trojan-grpc%26sni=${domain}#${user}"
trojan2="trojan://${uuid}@${domain}:443?path=%2FYOURPATH%2Ftrojan-ws%26security=tls%26host=${domain}%26type=ws%26sni=${domain}#${user}"
...
Link Trojan Account
_______________________________
Link WS : trojan://${uuid}@${domain}:443?path=%2FYOURPATH%2Ftrojan-ws&security=tls&host=${domain}&type=ws&sni=${domain}#${user}
_______________________________
...
Path TLS     : <code>/YOURPATH%2Ftrojan-ws</code>
...
echo -e "$COLOR1 ${NC} ${WH}Path WS      ${COLOR1}: ${WH}/YOURPATH/trojan-ws" | tee -a /etc/trojan/akun/log-create-${user}.log
...
Link Trojan Account
_______________________________
Link TLS : trojan://${uuid}@${domain}:443?path=%2FYOURPATH%2Ftrojan-ws&security=tls&host=${domain}&type=ws&sni=${domain}#${user}
_______________________________
Link gRPC : trojan://${uuid}@${domain}:443?mode=gun&security=tls&type=grpc&serviceName=trojan-grpc&sni=${domain}#${user}
_______________________________
END
...
Security     : auto
Network      : WS or gRPC
Path WS      : <code>/YOURPATH%2Ftrojan-ws</code>
Path GRPC    : <code>/trojan-grpc</code>
◇━━━━━━━━━━━━━━━━━◇
Link TLS    :
<code>${trojan2}</code>
...
echo -e "$COLOR1 ${NC} ${WH}Path TLS     ${COLOR1}: ${WH}/YOURPATH/trojan-ws" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}Path gRPC    ${COLOR1}: ${WH}/trojan-grpc" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ◇━━━━━━━━━━━━━━━━━◇ ${NC}" | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}Link TLS     ${COLOR1}: " | tee -a /etc/trojan/akun/log-create-${user}.log
echo -e "$COLOR1 ${NC} ${WH}${trojanlink}" | tee -a /etc/trojan/akun/log-create-${user}.log
