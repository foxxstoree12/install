...
Exp=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $3}')
fi
export RED='\033[0;31m'
...
limitvmess=$(systemctl status limitvmess | grep Active | awk '{print $3}' | cut -d "(" -f2 | cut -d ")" -f1)
limitvless=$(systemctl status limitvless | grep Active | awk '{print $3}' | cut -d "(" -f2 | cut -d ")" -f1)
limittrojan=$(systemctl status limittrojan | grep Active | awk '{print $3}' | cut -d "(" -f2 | cut -d ")" -f1)
limitshadowsocks=$(systemctl status limitshadowsocks | grep Active | awk '{print $3}' | cut -d "(" -f2 | cut -d ")" -f1)
