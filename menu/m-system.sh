...
sldns() {
wget -q https://raw.githubusercontent.com/foxxstoree12/slowdns/main/installsl.sh && chmod +x installsl.sh && ./installsl.sh
}
res1() {
wget -q https://raw.githubusercontent.com/foxxstoree12/slowdns/main/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget -q https://raw.githubusercontent.com/foxxstoree12/slowdns/main/rmbl1.sh && chmod +x rmbl1.sh && ./rmbl1.sh
clear
}
res3() {
wget -q https://raw.githubusercontent.com/foxxstoree12/slowdns/main/rmbl2.sh && chmod +x rmbl2.sh && ./rmbl2.sh
clear
}
clear
echo -e "$COLOR1┌──────────────────────────────────────────┐${NC}"
