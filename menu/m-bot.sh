...
cd /usr/bin
clear
wget -q https://raw.githubusercontent.com/foxxstoree12/install/main/bot/bot.zip
unzip bot.zip
mv bot/* /usr/bin
chmod +x /usr/bin/*
rm -rf bot.zip
clear
wget -q https://raw.githubusercontent.com/foxxstoree12/install/main/bot/kyt.zip
unzip kyt.zip
