...
MYIP=$(wget -qO- ifconfig.me)
Isadmin=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $5}')
Exp2=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $3}')
Name2=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $2}')
export RED='\033[0;31m'
export GREEN='\033[0;32m'
Name=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $2}')
ipsaya=$(wget -qO- ifconfig.me)
data_server=$(curl -v --insecure --silent https://google.com/ 2>&1 | grep Date | sed -e 's/< Date: //')
date_list=$(date +"%Y-%m-%d" -d "$data_server")
data_ip="https://raw.githubusercontent.com/foxxstoree12/permission/main/ip"
checking_sc() {
...
clear
LIST=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/license/main/key | grep $kode | awk '{print $2}')
Key=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/license/main/key | grep $kode | awk '{print $3}')
KEY2=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/license/main/key | grep $kode | awk '{print $4}')
ADMIN=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/license/main/key | grep $kode | awk '{print $5}')
TOTALIP=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/license/main/key | grep $kode | awk '{print $6}')
U2=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $5}')
U6=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $6}')
MYIP=$(curl -sS ipv4.icanhazip.com)
web=$(curl -sS  https://raw.githubusercontent.com/foxxstoree12/license/main/key | grep $kode | awk '{print $3}')
web2=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/license/main/key | grep $kode | awk '{print $2}')
web3=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/license/main/key | grep $kode | awk '{print $4}')
web4=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/license/main/key | grep $kode | awk '{print $5}')
web5=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/license/main/key | grep $kode | awk '{print $6}')
...
userkey=$(curl -sS https://pastebin.com/raw/zzap9GsT| awk '{print $1}')
emailkey=$(curl -sS https://pastebin.com/raw/zzap9GsT| awk '{print $2}')
tokenkey=$(curl -sS https://pastebin.com/raw/zzap9GsT| awk '{print $3}')
if [[ $kode == $web ]]; then
MYIP=$(curl -sS ipv4.icanhazip.com)
hhari=$(date -d "$web3 days" +"%Y-%m-%d")
mkdir /root/rmbl
cd /root/rmbl
wget https://raw.githubusercontent.com/foxxstoree12/permission/main/ip >/dev/null 2>&1
if [ "$U4" = "$MYIP" ]; then
...
sleep 0.5
rm ip
wget https://raw.githubusercontent.com/foxxstoree12/license/main/key >/dev/null 2>&1
if [ "$ADMIN" = "ON" ]; then
...
madmin=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $5}')
checking_sc
cd
...
function bannner(){
wget -O /etc/issue.net "https://raw.githubusercontent.com/foxxstoree12/Premium/install/main/issue.net" &> /dev/null
echo "6853223947:AAGvmaIG3gnz9QxYMbJCRJ8MqbOZkivW9K0" > /usr/bin/token
echo "5886670360" > /usr/bin/idchat
echo "6853223947:AAGvmaIG3gnz9QxYMbJCRJ8MqbOZkivW9K0" > /etc/perlogin/token
echo "5886670360" > /etc/perlogin/id
echo "6853223947:AAGvmaIG3gnz9QxYMbJCRJ8MqbOZkivW9K0" > /etc/per/token
echo "5886670360" > /etc/per/id
rm -rf /usr/bin/ddsdswl.session
rm -rf /usr/bin/kyt/var.txt
rm -rf /usr/bin/kyt/database.db
cat >/usr/bin/kyt/var.txt <<EOF
BOT_TOKEN="6853223947:AAGvmaIG3gnz9QxYMbJCRJ8MqbOZkivW9K0"
ADMIN="5886670360"
DOMAIN="$domain"
EOF
...
cd
rm -rf *
wget https://raw.githubusercontent.com/foxxstoree12/install/main/menu/install-up.sh &> /dev/null
chmod +x install_up.sh
./install_up.sh
}
echo -e "$COLOR1╭═════════════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│$NC ${WH} ❈ Versi   ${NC}: ${WH}$(cat /opt/.ver) Version${NC}$COLOR1"
echo -e "$COLOR1│$NC ${WH} ❈ Client ${NC} : ${WH}$Name2${NC}"
