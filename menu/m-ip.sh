...
listuser=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $2}')
superadmin=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $7}')
uu=$(curl -sS https://pastebin.com/raw/BZ9Fcnqf)
author=$(cat /etc/profil)
userscript=$(curl -sS https://pastebin.com/raw/UUMpYn3w | awk '{print $1}')
emailscript=$(curl -sS https://pastebin.com/raw/UUMpYn3w | awk '{print $2}')
tokenscript=$(curl -sS https://pastebin.com/raw/UUMpYn3w | awk '{print $3}')
userkey=$(curl -sS https://pastebin.com/raw/UUMpYn3w | awk '{print $1}')
emailkey=$(curl -sS https://pastebin.com/raw/UUMpYn3w | awk '{print $2}')
...
wget https://raw.githubusercontent.com/foxxstoree12/permission/main/ip &> /dev/null
...
git remote add origin https://github.com/foxxstoree12/permission.git &> /dev/null
git push -f https://${tokenscript}@github.com/foxxstoree12/permission.git &> /dev/null
else
echo -e "$COLOR1╭═════════════════════════════════════════════════╮${NC}"
echo -e "$COLOR1│${NC}${COLBG1}          ${WH}• PREMIUM SUPER ADMIN •                ${NC}$COLOR1│ $NC"
echo -e "$COLOR1╰═════════════════════════════════════════════════╯${NC}"
...
function add_ip(){
clear
nama2=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $2}')
author=$(cat /etc/profil)
TIMES="10"
...
sleep 1
REQIP=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | awk '{print $4}' | grep $daftar)
...
git branch -M main &> /dev/null
git remote add origin https://github.com/foxxstoree12/permission &> /dev/null
git push -f https://${tokenscript}@github.com/foxxstoree12/permission &> /dev/null
sleep 1
d1=$(date -d "$exp" +%s)
d2=$(date -d "$hariini" +%s)
...
sleep 0.5
rm /root/rmbl/ip
wget https://raw.githubusercontent.com/foxxstoree12/license/main/key &> /dev/null
clear
if [ "$superadmin" = "VIP" ]; then
x=1
while [ $x -le $mkey ]
...
git remote add origin https://github.com/foxxstoree12/license >/dev/null 2>&1
git push -f https://${tokenkey}@github.com/foxxstoree12/license >/dev/null 2>&1
echo -e "$COLOR1╭════════════════════════════════╮${NC}"
...
REQIP=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $iprenew | awk '{print $4}')
...
name1=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $iprenew | awk '{print $2}') #name
exp=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $iprenew | awk '{print $3}') #exp
ivps1=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $iprenew | awk '{print $4}') #ip
trial=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $iprenew | awk '{print $5}') #ip
MYIP=$(curl -sS ipv4.icanhazip.com)
UU2=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $2}')
U2=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $2}')
U3=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $3}')
U4=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $4}')
U5=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $5}')
...
regip2=$(expr "$U6" - "$ws")
sed -i "s/### $U2 $U3 $U4 $U5 $U6/### $U2 $U3 $U4 $U5 ${regip2}/g" ip
sed -i "s/### $name1 $exp $ivps1 $trial/### $masaaktif $exp $ivps1 @$UU2/g" ip
rm -rf .git
git init &> /dev/null
git add ip
git commit -m renew &> /dev/null
...
regip2=$(expr "$U6" - "$ws")
sed -i "s/### $U2 $U3 $U4 $U5 $U6/### $U2 $U3 $U4 $U5 ${regip2}/g" ip
sed -i "s/### $name1 $exp $ivps1/### $name1 $exp $masaaktif/g" ip
rm -rf .git
git init &> /dev/null
git add ip
git commit -m renew &> /dev/null
...
ip=$(curl -sS https://raw.githubusercontent.com/foxxstoree12/permission/main/ip | grep $MYIP | awk '{print $6}')
if [ "$Isadmin" = "ON" ]; then
echo -ne
else
clear
